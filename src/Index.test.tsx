...
describe('application tests', () => {
  ...
  it('should render name: Emad Ahmed', () => {
    const element = screen.getByTestId('name');

    checkContent(element, /^Emad Ahmed$/, undefined, true);
  });
  ...
  it('should render creator', () => {
    ...
    checkContent(element, /^Emad Ahmed$/, 'https://www.emadahmed.com/');
  });

  it('should render link to source code', () => {
    const element = screen.getByTestId('source');

    checkContent(element, /^Source$/, 'https://github.com/emadahmed/v2/');
  });
  ...
  it('should render GitHub button', () => {
    ...
    checkButton(parent, child, /^GitHub$/, 'https://github.com/Emad-Ahmed6699');
  });
  ...
  it('should render LinkedIn button', () => {
    ...
    checkButton(
      ...
      child,
      /^LinkedIn$/,
      'https://www.linkedin.com/in/emad-ahmed-296276346/',
    );
  });
  ...
  it('should render Resume button', () => {
    ...
    checkButton(
      ...
      child,
      /^Resume$/,
      'https://drive.google.com/file/d/1XUoH0fWiZ5eOKDrN2BsXcnK4KyNgwKyb/view?usp=sharing',
    );
  });
  ...
  it('should render Email button', () => {
    ...
    checkButton(parent, child, /^Email$/, 'mailto:emademad880800@gmail.com');
  });
  ...
  it('should render full footer on desktop', () => {
    ...
    expect(footer).toHaveTextContent(
      /^Designed and built by Emad Ahmed \| Source$/,
    );
  });
});
...
describe('app context tests', () => {
  it('should render partial footer on mobile', async () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by Emad Ahmed$/);
  });
